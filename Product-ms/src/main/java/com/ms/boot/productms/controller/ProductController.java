...
//	 @CircuitBreaker(name = "discountretry", fallbackMethod =
	// "calculateDiscountFallback")
	...
	public ResponseEntity<ProductDTO> calculateDiscountFallback(Integer id, Throwable t) {
		Product p = productService.getProductById(id);
